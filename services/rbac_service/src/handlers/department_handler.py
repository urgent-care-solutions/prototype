...
async def handle_department_create(msg: DepartmentCreate) -> DepartmentCreated:
    _log.info(f"Creating department of type {msg.type} for location {msg.location_id}")
...
@broker.publisher("audit.log.department")
async def handle_department_update(msg: DepartmentUpdate) -> DepartmentUpdated:
    ...
    dep_id = getattr(msg, "id", None) or getattr(msg, "department_id", None)
...
@broker.publisher("audit.log.department")
async def handle_department_delete(msg: DepartmentDelete) -> DepartmentDeleted:
    dep_id = getattr(msg, "id", None) or getattr(msg, "department_id", None)
